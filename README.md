# Mask R-CNN for Object Detection and Segmentation (Working with tf 2.4.1)

## Usage

- Uninstall tensorflow (if you have any version already there)
...
# Getting Started
* [demo.ipynb](vectoraizer/inference.ipynb) Is the easiest way to start. It shows an example of using a model pre-trained on MS COCO to segment objects in your own images.
It includes code to run object detection and instance segmentation on arbitrary images.

* [train_shapes.ipynb](vectoraizer/train.ipynb) shows how to train Mask R-CNN on your own dataset. This notebook introduces a toy dataset (Shapes) to demonstrate training on a new dataset.
